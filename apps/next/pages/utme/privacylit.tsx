...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - JAMB & WAEC CBT Prep 2026</title>
        <style>
          {`
        body {
      ...
      <div>
        <div>
          <div>
            <div>
              <h1>Privacy Policy for JAMB & WAEC CBT Prep 2026</h1>
              <div>Introduction</div>
              <div>
                {' '}
                Thank you for choosing to be part of our community at JAMB & WAEC CBT Prep 2026
