...
export default function Privacy() {
  return (
    <>
      <Head>
        <title>Privacy Policy - Biology TextBook SSS 1-3</title>
        <style>
          {`
        body {
      ...
      <div>
        <div>
          <div>
            <div>
              <h1>Privacy Policy for Biology TextBook SSS 1-3</h1>
              <div>Introduction</div>
              <div>
                {' '}
                Thank you for choosing to be part of our community at Biology TextBook SSS 1-3
